...
export const MOCK_ALERTS: Alert[] = [
  { id: 'ALT-001', title: 'Score Zerado — Modelo MDL-003 (10.3%)', description: 'Percentual de score zerado atingiu o limiar crítico de 10% na base do modelo de Fraude Transacional.', severity: 'CRITICAL', layer: 'ANALYTICS', triggeredAt: '2026-03-19T08:14:22Z', status: 'OPEN', triggerType: 'SCORE_ZERO', affectedProcess: 'MDL-003 Score Engine', suggestedAction: 'Verificar processo ETL-047 e reprocessar arquivo FFT corrompido.', autoAction: 'Processo de alertas enviados para equipe de dados via mensageria.' },
  { id: 'ALT-002', title: 'Falha Crítica — Job ETL-047 (Ingestion)', description: 'Job de ingestão ETL-047 falhou após 3 tentativas. Arquivo FFT não foi copiado corretamente.', severity: 'CRITICAL', layer: 'INGESTION', triggeredAt: '2026-03-19T07:58:10Z', status: 'ACKNOWLEDGED', triggerType: 'BATCH_FAILURE', affectedProcess: 'ETL-047 FFT Copy Job', suggestedAction: 'Reexecutar manualmente o job ETL-047 com validação de checksum.', acknowledgedAt: '2026-03-19T08:30:00Z' },
  { id: 'ALT-003', title: 'Latência Elevada — Trusted Layer (340ms)', description: 'Latência da camada Trusted atingiu 340ms, ultrapassando o limiar de 300ms definido.', severity: 'HIGH', layer: 'TRUSTED', triggeredAt: '2026-03-19T09:12:00Z', status: 'OPEN', triggerType: 'LATENCY', affectedProcess: 'Trusted Data Validation Service', suggestedAction: 'Escalar capacidade do serviço de validação. Verificar queries lentas.' },
  { id: 'ALT-004', title: 'Inconsistência — Variável Endereço (Enriquecimento)', description: 'Taxa de inconsistência na variável de endereço atingiu 8.2% na camada de Ingestion.', severity: 'HIGH', layer: 'INGESTION', triggeredAt: '2026-03-19T08:45:00Z', status: 'OPEN', triggerType: 'THRESHOLD', affectedProcess: 'Enrichment Service — Endereço', suggestedAction: 'Investigar fonte de dados de enriquecimento de endereço. Validar API externa.' },
  { id: 'ALT-005', title: 'Modelos sem Métricas — Analytics (900+)', description: 'Detectados 912 modelos analíticos sem métricas de monitoramento configuradas.', severity: 'MEDIUM', layer: 'ANALYTICS', triggeredAt: '2026-03-19T06:00:00Z', status: 'OPEN', triggerType: 'THRESHOLD', affectedProcess: 'Model Metrics Registry', suggestedAction: 'Mapear e configurar métricas para os 912 modelos não monitorados.' },
  { id: 'ALT-006', title: 'Job Atrasado — BATCH-092 (Trusted)', description: 'Job BATCH-092 está com 45 minutos de atraso em relação ao SLA definido.', severity: 'MEDIUM', layer: 'TRUSTED', triggeredAt: '2026-03-19T05:15:00Z', status: 'ACKNOWLEDGED', triggerType: 'BATCH_FAILURE', affectedProcess: 'BATCH-092 Trusted Sync', suggestedAction: 'Verificar dependências do job BATCH-092. Avaliar impacto no SLA downstream.', acknowledgedAt: '2026-03-19T05:30:00Z' },
  { id: 'ALT-007', title: 'Anomalia — Score PF Região Sul', description: 'Desvio padrão do Score PF detectado 2.3x acima do normal para a Região Sul.', severity: 'MEDIUM', layer: 'ANALYTICS', triggeredAt: '2026-03-19T10:01:00Z', status: 'RESOLVED', triggerType: 'ANOMALY', affectedProcess: 'MDL-005 Regional Score Engine', suggestedAction: 'Monitorar por 2h. Se persistir, acionar equipe de Data Science.', resolvedAt: '2026-03-19T10:10:00Z' },
];
